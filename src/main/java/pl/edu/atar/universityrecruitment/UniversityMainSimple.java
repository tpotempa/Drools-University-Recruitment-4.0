...
public class UniversityMainSimple {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(UniversityMainSimple.class);

    public static void main(String[] args) {

        // Tworzenie kolekcji 5 faktów
        List<UniversityCandidate> uc = new Dataset().getUniversityCandidates();
        ...
        for (UniversityCandidate fact : uc) {
            ...
            KieBase kBase = kContainer.getKieBase("simple");
